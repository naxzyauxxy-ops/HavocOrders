package net.eclipse.donutorders.economy;
...
public class EconomyHook {
    ...
    public EconomyHook(DonutOrders plugin) {
        this.plugin = plugin;
    }

    public boolean setup() {
        if (Bukkit.getPluginManager().getPlugin("Vault") == null) {
            plugin.getLogger().severe("Vault is not installed - DonutOrders needs it for the economy.");
            return false;
        }
